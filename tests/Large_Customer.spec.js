...
test.describe('test', () => {
    ...
    test('Large Customer', async () => {
        ...
        const demotestdata=[{name:'item1',item:'2435'},{name:'item3',item:'2465'},{name:'item4',item:'2419'},{name:'item5',item:'2476'},{name:'item6',item:'2423'},{name:'item7',item:'2469'},
        {name:'item8',item:'2487'},{name:'item9',item:'2478'},{name:'item10',item:'2605'}];
